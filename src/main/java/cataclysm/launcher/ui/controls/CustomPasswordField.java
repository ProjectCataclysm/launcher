...
public class CustomPasswordField extends PasswordField {
	...
	public CustomPasswordField() {
		...
		labelTranslate.toYProperty().bind(label.heightProperty().add(Bindings.createDoubleBinding(() -> 
				getInsets().getTop(), insetsProperty())).negate());
		...
		labelAnimation = new ParallelTransition(labelTranslate, labelFade);
